  ...
  return (
    <Flex direction="column" gap="2rem">
      ...
      <Flex direction={{ base: "column", medium: "row" }} gap="1rem" wrap="wrap">
        <Card variation="elevated" flex="1" padding="1rem" backgroundColor="background.primary">
          <Flex alignItems="center" gap="1rem">
            <View padding="0.75rem" backgroundColor="primary.10" borderRadius="50%">
        ...
        <Card variation="elevated" flex="1" padding="1rem" backgroundColor="background.primary">
          <Flex alignItems="center" gap="1rem">
            <View padding="0.75rem" backgroundColor="#ebf5ff" borderRadius="50%">
        ...
        <Card variation="elevated" flex="1" padding="1rem" backgroundColor="background.primary">
          <Flex alignItems="center" gap="1rem">
            <View padding="0.75rem" backgroundColor="#ecfdf5" borderRadius="50%">
      ...
      {upcomingDeadlines.length > 0 && (
        <Card variation="elevated" padding="1.5rem" backgroundColor="background.primary">
          <Flex direction="column" gap="1rem">
            ...
            <Collection items={upcomingDeadlines} type="list" gap="0.5rem" direction="column">
              {(task, index) => (
                <Card
                  key={index}
                  padding="1rem"
      ...
      <Card variation="elevated" padding="1.5rem" backgroundColor="background.primary">
        <Flex direction="column" gap="1.5rem">
          <Flex justifyContent="space-between" alignItems="center">
            ...
            <Button size="small" onClick={() => {}} variation="link">
          ...
          {getFilteredTasks().length === 0 ? (
            ...
            <Collection items={getFilteredTasks()} type="list" gap="1rem" direction="column">
              {(task) => (
                <TaskCard
                  key={task.id}
                  task={task}
